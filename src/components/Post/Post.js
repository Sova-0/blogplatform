...
const Post = () => {
    ...
    const { title, createdAt, favoritesCount, description, body, tagList, favorited } = article;
                        ...
                        {isAuthor ? (
                            <div className="user-info__button">
                                <Popconfirm
                                    ...
                                    cancelText="Нет"
                                >
                                    <Button danger type="primary" className="user-info__button-delete">
                                        Delete
                                    </Button>
                                </Popconfirm>
                                <Link className="user-info__button-edit" to={`/articles/${slug}/edit`}>Edit</Link>
                            </div>
                        ) : ''}
                    </div>
                </div>
