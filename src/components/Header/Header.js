...
const Header = () => {
    ...
    return (
        <div className='App-header'>
            <Link className="to-main-page" to="/">Realworld Blog</Link>
            {isLogin ?
                <div className='App-header__login'>
                    <Link className='App-header__login-create-article' to='/new-article'>Create article</Link>
                    <div className='App-header__login-user-name-avatar'>
                        ...
                        <Link to='/profile' className='App-header__login-user-avatar'>
                            <img className='App-header__login-user-avatar' src={image || '/user-avatar.png'} alt='User Avatar'></img>
                        </Link>
                    </div>
                    <Link className='App-header__login-logout' to='/'
                        onClick={() => dispatch(logout())}>Log Out</Link>

                </div> :
                <div className='sign-in-sign-up-buttons'>
                    <Link className='sign-in-buttons' to="/sign-in">Sign In</Link>
                    <Link className='sign-up-buttons' to="/sign-up">Sign Up</Link>
                </div>
            }
        </div>
    )
