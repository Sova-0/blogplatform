        ...
        <form className="sign-up" onSubmit={handleSubmit(onSubmit)}>
            <div className="sing-up__data">
                ...
                <div className="sign-up__user-name">
                    Username
                    <input type="text" placeholder="Username" {...register("userName", { required: true, minLength: 3, maxLength: 20 })} />
                    {errors.userName && <p className="error">Username is required (3–20 chars)</p>}
                </div>
                ...
                <div className="sign-up__password">
                    Password
                    <input type="text" placeholder="Password" {...register("password", { required: true, minLength: 6, maxLength: 20 })} />
                    {errors.password && <p className="error">Password must be valid (6–20 chars)</p>}
                </div>
                <div className="sign-up__repeat-password">
                    Repeat Password
                    <input type="text" placeholder="Repeat Password" {...register("repeatPassword", {
                        required: true,
                        validate: (value) => value === watch("password")
                    })} />
                    {errors.repeatPassword && <p className="error">Password must be repeat</p>}
                </div>
            </div>
            ...
            <div className="sign-up__create-acc">
                <button type="submit" className="sign-up__create-acc-button">Create</button>
                <div className="sign-up__create-acc-info">
                    <div className="sign-up__create-acc-info-text">Already have an account?</div>
