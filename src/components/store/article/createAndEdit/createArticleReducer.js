...
const createArticleSlice = createSlice({
    ...
    reducers: {
        ...
        removeTag(state, action) {
            state.tagList = state.tagList.filter((_, index) => index !== action.payload);
        },
...
export const { setTitle, setDescription, setBody, addTag, removeTag, setTagList, resetArticleForm } = createArticleSlice.actions;
